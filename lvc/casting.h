//
// This is a copy of llvm/Support/Casting.h, except the templates are not
// in the llvm namespace (and it uses #pragma once).
//
...
template<typename From> struct simplify_type<const From> {
    ...
    typedef typename llvm::add_const_past_pointer<NonConstSimpleType>::type
    SimpleType;
    typedef typename llvm::add_lvalue_reference_if_not_pointer<SimpleType>::type
    RetType;
